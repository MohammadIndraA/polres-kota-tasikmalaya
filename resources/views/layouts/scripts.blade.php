   ...
   <!-- JS -->
   <script src="{{ asset('design-system/assets/libs/sweetalert2/sweetalert2.all.min.js') }}"></script>
   <script src="{{ asset('design-system/assets/js/pages/sweetalert.init.js') }}"></script>
