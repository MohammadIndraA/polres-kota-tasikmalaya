...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('design-system/assets/images/logo-sb-v2.png') }}" />
    ...
    <div class="min-h-full z-[99]  fixed inset-y-0 print:hidden dark:bg-[#06090f] main-sidebar duration-300 bg-white">
        <div
            ...
            <a href="index.html" class="logo">
                <span>
                    <img src="{{ asset('design-system/assets/images/logo-sb-v2.png') }}" alt="logo-small"
                        class="logo-sm h-8 align-middle inline-block">
                </span>
                <span>
                    <img src="{{ asset('design-system/assets/images/logo-text-v2.png') }}" alt="logo-large"
                    ...
                    <img src="{{ asset('design-system/assets/images/logo-text.png') }}" alt="logo-large"
