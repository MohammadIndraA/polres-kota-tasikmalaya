                        ...
                        <div class="row-fluid">
                            ...
                            <div id="breadcrumbs">
                                <span class="breadcrumb-title">You Are Here:</span><span><a
                                    ...
                                    class="current">Berita Detail</span>
                            </div>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <div id="post-138"
                                                        ...
                                                        <div class="post-upper textcenter">
                                                            <div class="post-meta-data style2">
                                                                ...
                                                                <span
                                                                    class="post-meta-date">{{ $post->created_at->format('F d, Y') }}</span>
                                                            </div>
                                                            <h2><a href="#"
                                                        ...
                                                        <div class="image hoverlay">
                                                            <a href="#">
                                                                <img width="1100" height="734"
                                                                    src="{{ $post->image ? asset('storage/' . $post->image) : asset('frontend/upload/blog1.jpg') }}"
                                                                    class="attachment-fullwidth wp-post-image"
                                                                    alt="{{ $post->title ?? 'blog1' }}" />
                                                            </a>
                                                        </div>
                                                        <!-- post content -->
