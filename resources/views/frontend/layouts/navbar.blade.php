        ...
        <ul id="mobile_menu" class="mobile_menu">
            ...
            <li class="menu-item menu-item-has-children menu-item-6814"><a href="#">Pelayanan Publik Terpadu</a>
                <ul class="sub-menu">
                    ...
                    <li class="menu-item"><a href="blog-grid-fullwidth.html">Blog Grid With Sidebar</a></li>
                </ul>
            </li>
            <li class="menu-item"><a href="contact-us-2.html">Berita</a></li>
            <li class="menu-item"><a href="contact-us-2.html">Contact Us</a></li>
        </ul>
    </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="logo-container">
                                    <a id="logo" href="index.html">
                                        <img src="{{ asset('frontend/images/logo.png') }}" class="default-logo"
                                            alt="Aperio">
                                        <img src="{{ asset('frontend/images/logowhite.png') }}" class="white-logo"
                                            alt="Aperio">
                                    </a>
                                </div>
                                ...
                                <nav class="nav-container">
                                    <ul id="main_menu" class="main_menu">
                                        ...
                                        <li class="menu-item menu-item-has-children"><a href="#">Pelayanan Publik
                                                Terpadu</a>
                                            <ul class="sub-menu ">
                                                <li class="menu-item"><a href="blog-grid.html">Blog Grid</a></li>
                                                <li class="menu-item"><a href="blog-grid-fullwidth.html">Blog Grid
                                                        With Sidebar</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item"><a href="contact-us-2.html">Berita</a></li>

                                        <li class="menu-item menu-item-has-children"><a href="#">Galery</a>
                                            <ul class="sub-menu ">
                                                <li class="menu-item"><a href="shop.html">Cooming Soon</a></li>
                                        </li>
                                    </ul>
                                    </li>
                                    <li class="menu-item"><a href="contact-us-2.html">Contact Us</a></li>
                                    <li class="cart-container">
                                        <!-- Cart Icons -->
                                        <a class="cart-icon-wrapper" href="#"><span class="cart-icon"><i
                                                    class="fa-shopping-cart"></i></span><span
