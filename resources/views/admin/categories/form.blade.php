@extends('layouts.app', ['title' => 'Form Kategori'])
@section('content')
                ...
                <div
                    ...
                    <div class="border-b border-slate-200 dark:border-slate-700/40 py-3 px-4 dark:text-slate-300/70">
                        <div class="flex-none md:flex">
                            <h4 class="font-medium text-lg flex-1 self-center mb-2 md:mb-0">Form Kategori</h4>
                        </div>
                    ...
                    <div class="flex-auto p-4">
                        <form
                            ...
                            <x-input-v2 name="name" label="Nama" :value="old('nama', $category->name ?? '')" placeholder="Nama Kategori"
