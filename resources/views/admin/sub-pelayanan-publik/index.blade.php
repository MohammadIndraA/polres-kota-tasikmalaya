            ...
            <div class="w-full relative mb-4">
                <div class="flex-auto p-0 md:p-4">
                    <div class="flex flex-wrap gap-4 mb-3">
                        <div>
                            <a href="{{ route('admin.sub-pelayanan-publik.create') }}"
                    ...
                    <div
                        ...
                        <div class="sm:-mx-6 lg:-mx-8">
                            <div class="relative overflow-x-auto block w-full sm:px-6 lg:px-8">
                                <table class="w-full" id="sub_pelayananTable">
...
@section('scripts')
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#sub_pelayananTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.sub-pelayanan-publik.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
                        sortable: false
